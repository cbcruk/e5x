...
const catalog = [
  { type: 'apples', dept: 'produce', price: 2, quantity: 30, organic: true, note: 'Imported via JSX' },
  { type: 'yogurt', dept: 'dairy', price: 3.5, quantity: 12, organic: false, note: '' },
  { type: 'bagels', dept: 'bakery', price: 1.25, quantity: 24, organic: false, note: 'Imported via JSX' },
];
